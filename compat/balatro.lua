return {
    content = {
        ...
        JokerCategories = {
            ...
            ['j_greedy_joker']        = { MadLib.JokerLists.Mult.Add, MadLib.JokerLists.Suit['Diamonds'] },
            ['j_lusty_joker']         = { MadLib.JokerLists.Mult.Add, MadLib.JokerLists.Suit['Hearts'] },
            ['j_wrathful_joker']      = { MadLib.JokerLists.Mult.Add, MadLib.JokerLists.Suit['Spades'] },
            ['j_gluttenous_joker']    = { MadLib.JokerLists.Mult.Add, MadLib.JokerLists.Suit['Clubs'] },

            ['j_jolly']       = { MadLib.JokerLists.Mult.Add, MadLib.JokerLists.HandType['Pair'] },
            ['j_zany']        = { MadLib.JokerLists.Mult.Add, MadLib.JokerLists.HandType['Three of a Kind'] },
            ['j_mad']         = { MadLib.JokerLists.Mult.Add, MadLib.JokerLists.HandType['Two Pair'] },
            ['j_crazy']       = { MadLib.JokerLists.Mult.Add, MadLib.JokerLists.HandType['Straight'] },
            ['j_droll']       = { MadLib.JokerLists.Mult.Add, MadLib.JokerLists.HandType['Flush'] },

            ['j_sly']         = { MadLib.JokerLists.Chips.Add, MadLib.JokerLists.HandType['Pair'] },
            ['j_wily']        = { MadLib.JokerLists.Chips.Add, MadLib.JokerLists.HandType['Three of a Kind'] },
            ['j_clever']      = { MadLib.JokerLists.Chips.Add, MadLib.JokerLists.HandType['Two Pair'] },
            ['j_devious']     = { MadLib.JokerLists.Chips.Add, MadLib.JokerLists.HandType['Straight'] },
            ['j_crafty']      = { MadLib.JokerLists.Chips.Add, MadLib.JokerLists.HandType['Flush'] },
            ...
            ['j_runner']          = { MadLib.JokerLists.Chips.Add, MadLib.JokerLists.Scaling.Chips, MadLib.JokerLists.HandType['Straight'] },
            ...
            ['j_sixth_sense']     = { MadLib.JokerLists.Generative.Consumable, MadLib.JokerLists.Destructive.Card, MadLib.JokerLists.Rank['6'] },
            ...
            ['j_superposition']   = { MadLib.JokerLists.Generative.Card, MadLib.JokerLists.HandType['Straight'], MadLib.JokerLists.Rank['Ace'] },
            ...
            ['j_seance']          = { MadLib.JokerLists.Generative.Consumable, MadLib.JokerLists.HandType['Straight Flush'] },
            ...
            ['j_baron']       = { MadLib.JokerLists.Mult.Multiply, MadLib.JokerLists.Rank['King'] },
            ['j_cloud_9']     = { MadLib.JokerLists.Money.Add, MadLib.JokerLists.Rank['9'] },
            ...
            ['j_trousers']    = { MadLib.JokerLists.Mult.Add, MadLib.JokerLists.Scaling, MadLib.JokerLists.HandType['Two Pair'] },
            ...
            ['j_rough_gem']       = { MadLib.JokerLists.Money.Add, MadLib.JokerLists.Suit['Diamonds'] },
            ['j_bloodstone']      = { MadLib.JokerLists.Mult.Multiply, MadLib.JokerLists.Probability, MadLib.JokerLists.Suit['Hearts'] },
            ['j_arrowhead']       = { MadLib.JokerLists.Chips.Add, MadLib.JokerLists.Suit['Spades'] },
            ['j_onyx_agate']      = { MadLib.JokerLists.Mult.Add, MadLib.JokerLists.Suit['Clubs'] },
            ...
            ['j_wee']             = { MadLib.JokerLists.Chips.Add, MadLib.JokerLists.Scaling.Chips, MadLib.JokerLists.Rank['2'] },
            ...
            ['j_seeing_double']   = { MadLib.JokerLists.Mult.Multiply, MadLib.JokerLists.Suit['Clubs'] },
            ['j_matador']         = { MadLib.JokerLists.Money.Add },
            ['j_hit_the_road']    = { MadLib.JokerLists.Mult.Multiply, MadLib.JokerLists.Rank['Jack'] },

            ['j_duo']         = { MadLib.JokerLists.Mult.Multiply, MadLib.JokerLists.HandType['Pair'] },
            ['j_trio']        = { MadLib.JokerLists.Mult.Multiply, MadLib.JokerLists.HandType['Three of a Kind'] },
            ['j_family']      = { MadLib.JokerLists.Mult.Multiply, MadLib.JokerLists.HandType['Two Pair'] },
            ['j_order']       = { MadLib.JokerLists.Mult.Multiply, MadLib.JokerLists.HandType['Straight'] },
            ['j_tribe']       = { MadLib.JokerLists.Mult.Multiply, MadLib.JokerLists.HandType['Flush'] },
            ...
            ['j_shoot_the_moon']  = { MadLib.JokerLists.Mult.Add, MadLib.JokerLists.Rank['Queen'] },
